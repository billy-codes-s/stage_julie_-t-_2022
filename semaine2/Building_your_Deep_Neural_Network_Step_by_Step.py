...
def linear_activation_forward(A_prev, W, b, activation):
    ...
    ## ((a[L-1], W[L], B[L]), (Z(L))) i mean sure, all these points of data are pretty useful, and btw this is for
    ### the whole layer... I guess, yes, strange, very strange, but nontheless interesting formatting and met
...
def L_model_forward(X, parameters):
    ...
    caches = []
    A = X
    L = len(parameters) // 2                  # number of layers in the neural network, whatever is this really nec.
    ...
    # YOUR CODE ENDS HERE
    return AL, caches
## very strange way of doing this indeed I wonder how we could make this better I am learning at a fast rate
